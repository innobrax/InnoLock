...
public class MainActivity extends Activity {
    ...
    private void startScan() {
        ...
        appendLog("Iniciando scan BLE por serviço NUS: " + SERVICE_UUID);
    ...
    private final ScanCallback scanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            boolean hasService = record != null && record.getServiceUuids() != null
                    && record.getServiceUuids().contains(new ParcelUuid(SERVICE_UUID));

            if (!nameLooksValid && !hasService) {
                return;
            }
    ...
    private final BluetoothGattCallback gattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            mainHandler.postDelayed(() -> sendCommand("ID?"), 700);
            mainHandler.post(() -> {
